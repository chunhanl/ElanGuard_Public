...
#-------------Modules (Without Face)-----------------------------------------------------
Detector                 = detectors.Yolov3()
PersonReID_Filter        = None
PersonReID_Embedder      = embedders.Triplet_Embedder()
FaceReID_Filter          = None
FaceReID_Embedder        = None

#Tracker                  = trackers.IOUTracker()
#Tracker                  = trackers.TripletTracker()
Tracker                  = trackers.Triplet_w_IOUTracker()
PersonReID_Identifier    = identifiers.TripletReid()
FaceReID_Identifier      = None
