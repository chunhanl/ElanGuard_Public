...
parser.add_argument(
    '--excluder', default='market1501', choices=('market1501', 'diagonal'),
    help='Excluder function to mask certain matches. Especially for multi-'
         'camera datasets, one often excludes pictures of the query person from'
         ' the gallery if it is taken from the same camera. The `diagonal`'
         ' excluder should be used if this is *not* required.')
...
parser.add_argument(
    '--query_dataset', default='data/market1501_query.csv',
    help='Path to the query dataset csv file.')

parser.add_argument(
    '--query_embeddings', default='./checkpoints/market1501_query_embeddings.h5', 
    help='Path to the h5 file containing the query embeddings.')

parser.add_argument(
    '--gallery_dataset', default='data/market1501_test.csv',
    help='Path to the gallery dataset csv file.')

parser.add_argument(
    '--gallery_embeddings', default='./checkpoints/market1501_test_embeddings.h5',
    help='Path to the h5 file containing the query embeddings.')
